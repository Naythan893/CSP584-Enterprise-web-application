...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<div id='content' float='left'>");
		pw.print("<div class='post' style='padding:0px'>");
		pw.print("<h2 class='title'>");
		pw.print("<a href='#'>Welcome to Bike2Go </a></h2>");

		pw.print("<div class='entry'>");
		//pw.print("<img src='images/laptop/consoles.pngstyle='width: 600px; display: block; margin-left: auto; margin-right: auto' />");
		//pw.print("<br> <br>");
		//pw.print("<h2>The world trusts us to deliver SPEEDY service for Smartportables fans</h2>");
		//pw.print("<br> <br>");
		pw.print("<h1>Get your matching Deals and Ride ON !</h2>");
...
//
		...
		{
		pw.print("<li id='item'><img src='images/"+"phone"+"/"+entry.getValue().getImage()+"' alt='' />");
		}
		else
		{
		pw.print("<li id='item'><img src='images/"+"speaker"+"/"+entry.getValue().getImage()+"' alt='' />");
		}
