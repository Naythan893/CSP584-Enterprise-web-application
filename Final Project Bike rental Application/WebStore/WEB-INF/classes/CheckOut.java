...
public class CheckOut extends HttpServlet {
	...
	protected void storeOrders(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String orderTotal = request.getParameter("orderTotal");
				Double rentTotal = Double.parseDouble(orderTotal);
				rentTotal= Math.round(rentTotal * 100.0) / 100.0;//Double.format("%.2f", );
		...
		{
			pw.print("<tr><td>Rented Bike/Accessory Type</td><td>");
			pw.print(oi.getName()+"</td></tr><tr><td>");
			pw.print("<input type='hidden' name='orderPrice' value='"+oi.getPrice()+"'>");
			pw.print("<input type='hidden' name='orderName' value='"+oi.getName()+"'>");
			pw.print("Rent Price:</td><td>"+ oi.getPrice());
			pw.print("</td></tr>");
		}
		pw.print("<tr><td>");
        pw.print("Total cost of renting</td><td>"+rentTotal);
		pw.print("<input type='hidden' name='orderTotal' value='"+rentTotal+"'>");
        ...
        pw.print("</td></tr>");
			...
			pw.print("<tr><td>");
		pw.print("No. of days</td>");
	pw.print("<td><input type='text' name='days'>");
	pw.print("</td></tr>");
