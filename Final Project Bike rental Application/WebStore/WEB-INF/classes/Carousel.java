...
public class Carousel{
	...
	public String  carouselfeature(Utilities utility){
		...
		for(String user: prodRecmMap.keySet())
		{
          ...
          if(prodObj.getType().equals("bike"))
          {
          sb.append("<li id='item'><img src='images/"+"phone"+"/"+prodObj.getImage()+"' alt='' /></li>");
          }
          else
          {
            sb.append("<li id='item'><img src='images/"+"speaker"+"/"+prodObj.getImage()+"' alt='' /></li>");
          }
