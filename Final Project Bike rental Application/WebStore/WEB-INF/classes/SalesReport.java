...
//    }
    ...
    private void displaySalesReport(HttpServletRequest request,
        ...
        pw.print("Table of Bikes rented");
        pw.print("</h3>");
        pw.print("<div class='entry'>");

        pw.print("<table class='gridtable'>");
        pw.print("<tr>");
        pw.print("<td>Bike Name</td>");
        pw.print("<td>Rent per day</td>");
        pw.print("<td>No. of Bikes</td>");
        pw.print("<td>No. of Days rented</td>");
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
            Double sales = new Double(orderPayment.getSaleAmount());
            Double orderpr = orderPayment.getOrderPrice();
            Double days = orderPayment.getDays();
            Double totsales = (Double)  sales * days * orderpr;
            pw.print("<tr>");
            pw.print("<td>" + orderPayment.getOrderName() + "</td>" +
                    "<td>" + orderPayment.getOrderPrice() + "</td>" +
                    "<td>" + orderPayment.getSaleAmount() + "</td>" +
                    "<td>" + orderPayment.getDays() + "</td>" +
                    "<td>" + String.format("%.2f", totsales) + "</td>");
            pw.print("</tr>");
        ...
        pw.println("google.charts.load('current', {'packages':['corechart', 'line']});");
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
          ...
          Double days = orderPayment.getDays();
          Double totsales = (Double)  sales * days*  orderpr;
            pw.println(" ['" + orderPayment.getOrderName() + "', " + String.format("%.2f", totsales) + "],");
        ...
        pw.println("       'height':500,vAxis: {title: 'Inventory Name'},hAxis: {title: 'Total Sales'}};");
        ...
        pw.print("<div class='post'>");
        pw.print("<h3 class='title'>");
        pw.print("Bar Chart of Bikes rented");
        pw.print("</h3>");
        pw.print("<div class='entry'>");
        ...
        pw.print("<tr>");
        pw.print("<td>Date</td>");
        pw.print("<td>No. of bikes rented</td>");
        pw.print("<td>Total Sales</td>");
        pw.print("</tr>");
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
            ...
            pw.print("<td>" + orderTime + "</td>" +
                    "<td>" + orderPayment.getSaleAmount() + "</td>" +
                    "<td>" + orderPayment.gettotCostperday() + "</td>");
            pw.print("</tr>");
        ...
        pw.print("<div class='post'>");
        pw.print("<h3 class='title'>");
        pw.print("Bar Chart of Daily sales");
        pw.print("</h3>");
        pw.print("<div class='entry'>");
        pw.println("<div id='chart_div2'></div>");
        pw.print("</div></div></div>");
        //////////<script>
        pw.println("<script type='text/javascript' src=\"https://www.gstatic.com/charts/loader.js\"></script>");
        pw.println("<script type='text/javascript'>");
        ...
        for (OrderPayment orderPayment : orderPaymentHashMap.values()) {
          ...
          Double totsales = (Double)  orderPayment.gettotCostperday();
            pw.println(" ['" + orderTime + "', " + String.format("%.2f", totsales) + "],");
             /*pw.println(" ['Mushrooms', 3],");
              pw.println("['Onions', 1],");n
            pw.println("  ['Olives', 1],");
            pw.println("  ['Zucchini', 1],");
        ...
        pw.println(" var options = {'title':'Sales Report',");
        pw.println("        'width':800,");
        pw.println("       'height':500,vAxis: {title: 'Inventory Name'},hAxis: {title: 'Total Sales',maxValue:500}};");

        // Instantiate and draw our chart, passing in some options.
        pw.println(" var chart = new google.visualization.LineChart(document.getElementById('chart_div2'));");
        pw.println("  chart.draw(data, options);     }");
        pw.println(" </script>");
