...
response.setContentType("text/html");
 ...
 pw.println("<body>");
		...
		pw.print("<td><div id='shop_item'>");
			...
			if(data.getType().equals("bike"))
			{
				pw.print("<li id='item'><img src='images/"+"phone"+"/"+data.getImage()+"' alt='' /></li>");
			}
			else
			{
				pw.print("<li id='item'><img src='images/"+"speaker"+"/"+data.getImage()+"' alt='' /></li>");
			}
