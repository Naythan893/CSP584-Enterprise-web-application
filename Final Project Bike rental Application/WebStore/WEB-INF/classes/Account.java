			...
			if(size>0)
				{
					...
					pw.print("<tr style='background:black;text:white;'><td></td>");
					pw.print("<td>OrderId:</td>");
					pw.print("<td>UserName:</td>");
					pw.print("<td>Product Name:</td>");
					pw.print("<td>Product Price per day:</td>");
					pw.print("<td>Days rented</td>");
					pw.print("<td>Total Cost</td></tr>");
					for(Map.Entry<Integer, ArrayList<OrderPayment>> entry : orderPayments.entrySet())
					{
						...
						if(oi.getUserName().equals(user.getName()))
						{
							...
							pw.print("<td>"+oi.getOrderId()+".</td><td>"+oi.getUserName()+"</td><td>"+oi.getOrderName()+"</td><td>Price: "+oi.getOrderPrice()+"</td><td>"+oi.getDays()+"</td><td>"+oi.getTotalCost()+"</td>");
							pw.print("<td><input type='hidden' name='orderId' value='"+oi.getOrderId()+"'>");
							pw.print("<input type='submit' name='Order' value='CancelOrder' class='btnbuy'></td>");
							pw.print("</tr>");
							pw.print("</form>");
