...
public class Trending extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        pw.print("<a style='font-size: 24px;'>Top 5 most liked Bikes based on rating</a>");
        ...
        pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
        pw.print("<a style='font-size: 24px;'>Top 5 zip-codes where maximum number of bikes rented</a>");
        pw.print("</h2><div class='entry'><table id='bestseller'>");
        ...
        pw.print("<div id='content'><div class='post'><h2 class='title meta'>");
        pw.print("<a style='font-size: 24px;'>Top 5 most rented bikes regardless of the rating</a>");
        pw.print("</h2><div class='entry'><table id='bestseller'>");
